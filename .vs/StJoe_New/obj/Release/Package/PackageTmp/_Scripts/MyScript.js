$(document).ready(function () {
    ...
    $('#ChristmasImg').click(function () {
        window.open('_PDFs/2020-01 SJOF Christmas Concert.pdf', '')
    })

    $('#HamImg').click(function () {
    ...
    $('#FashionImg').click(function () {
        window.open('_PDFs/2020-03-07 - Fashion Show Flier 2.pdf', '')
    })
    ...
    $('#eventMnu').click(function () {
        //window.open('_PDFs/ChristmasBazaar.pdf', '')
        $('.myArt').addClass('noDisplay').removeClass('block');
    ...
    $('#MeatloafImg').click(function () {
        window.open('_PDFs/meatloaf.pdf', '');
    });
